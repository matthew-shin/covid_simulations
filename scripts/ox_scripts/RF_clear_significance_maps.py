...
if __name__=="__main__":
    ...
    for i, experiment in enumerate(['3A1','3A2','3A3','3A4']):
        ...
        mean2014, diff2014, meanDiff2014, var2014 = calculate_stats(FClearCleanDataset2014[experiment], FClearCleanDataset2014['Con'])
        mean2013, diff2013, meanDiff2013, var2013 = calculate_stats(FClearCleanDataset2013[experiment], FClearCleanDataset2013['Con'])
        mean2012, diff2012, meanDiff2012, var2012 = calculate_stats(FClearCleanDataset2012[experiment], FClearCleanDataset2012['Con'])
    ...
    plt.suptitle('Clear Sky TOA RF')
    plt.savefig('clear-sky_95_RF_maps.jpg')
    #plt.show()
