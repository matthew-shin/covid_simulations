...
# 2013
#aths = {'Con': '../../nc_files/u-bt341/', '3A1': '../../nc_files/u-bt342/', '3A2': '../../nc_files/u-bt343/', '3A3': '../../nc_files/u-bt344/', '3A4': '../../nc_files/u-bt345/'}
...
if __name__=="__main__":
    ...
    plt.suptitle('O3 Zonal Mean Concentration')
    plt.savefig('zon_o3_new.png')
    ...
    for ax in [ax1, ax3]:
        ax.set_ylabel('Altitude / m')
    plt.suptitle('Difference in zonal mean O3')
    plt.savefig('zon_o3_diff_new.png')
    ...
    cax, kw = matplotlib.colorbar.make_axes(axes, location='bottom', pad=0.1, shrink=0.7)
    cb = plt.colorbar(p, cax=cax, extend='both', **kw)
    cb.set_label('O3 zonal percentage diff / %')
    for ax in [ax4, ax2]:
        ax.set_yticks([])
    for ax in [ax1, ax3]:
        ax.set_ylabel('Altitude / m')
    plt.suptitle('Percentage difference in zonal mean O3')
    plt.savefig('zon_o3_perc_new.png')
