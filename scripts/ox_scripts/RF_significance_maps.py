...
if __name__=="__main__":
    ...
    for i, experiment in enumerate(['3A1','3A2','3A3','3A4']):
        ...
        mean2014, diff2014, meanDiff2014, var2014 = calculate_stats(FDataset2014[experiment], FDataset2014['Con'])
        mean2013, diff2013, meanDiff2013, var2013 = calculate_stats(FDataset2013[experiment], FDataset2013['Con'])
        mean2012, diff2012, meanDiff2012, var2012 = calculate_stats(FDataset2012[experiment], FDataset2012['Con'])
        ...
        p = axgr[i].pcolormesh(plotLon, plotLat, plotTMD, cmap='bwr', transform=ccrs.PlateCarree(), vmin=-3, vmax=+3)
    ...
    #cb = fig.colorbar(p, ax=axgr[:,:], shrink=0.8, location='bottom', extend='both')
    #cb.set_label('Column Difference / %')
    cb.set_label('RF / Wm-2')
    plt.suptitle('Total TOA RF')
    plt.savefig('total_95_RF_maps.jpg')
    #plt.show()
